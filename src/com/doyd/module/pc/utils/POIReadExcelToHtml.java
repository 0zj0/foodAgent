...
public class POIReadExcelToHtml {
	...
	public static void main(String[] args) {
		...
		String path = "E://Microsoft Excel 工作表.xlsx";// E://Microsoft Excel
														// 工作表.xlsx
		InputStream is = null;
	...
	/**
	 * 
	 * @Title: readExcelToHtml
	 * @param input
	 * @param isWithStyle
	 * @return String
	 * @author 创建人：王伟
	 * @date 创建时间：2018-1-3 下午5:18:20
	 */
	public static String readExcelToHtml(InputStream input, boolean isWithStyle) {
		String htmlExcel = null;
		try {
